...
namespace MonitorActivity
{
    class DiskInfo
    {
        ...
        {
            // Récupérer la liste des disques disponibles
            DriveInfo[] drives = DriveInfo.GetDrives();

            // Extraire les noms des disques
            List<string> driveNames = new List<string>();
            foreach (DriveInfo drive in drives)
            {
                // Convertir les valeurs en gigaoctets
                ...
                // Ajouter les informations du disque formatées en Go
